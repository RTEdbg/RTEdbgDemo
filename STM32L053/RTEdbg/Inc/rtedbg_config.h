 ...
 *
 * @note This configuration file was made for the STM32L053 demo.
...
#if 1  // Example: Timer SYSTICK used as the timestamp counter
...
#if 0   // Example: a 16 bit timer TIM2 used as the timestamp counter for the STM32L0 family
        // @note The RTE_FMT_ID_BITS must be set to 15
#define RTE_TIMER_DRIVER  "rtedbg_timer_stm32L0_tim2.h"
...
#define RTE_OPTIM_SPEED  __attribute__((optimize("Os")))
#define RTE_OPTIM_LARGE  __attribute__((optimize("Og")))
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#else                           // Unknown compiler
