...
"c:\RTEdbg\UTIL\RTEgdbData\RTEgdbData.exe" 61234 0x20000000 0x1028 -filter=0xFFFFFFFF -p -start=init.cmd -clear -decode=Decode.bat -filter_names=..\..\Debug\Filter_names.txt
