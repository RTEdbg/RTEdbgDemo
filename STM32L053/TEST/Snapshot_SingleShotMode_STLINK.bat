...
"c:\ST\STM32CubeProgrammer\bin\STM32_Programmer_CLI.exe" -c port=SWD mode=HOTPLUG shared -q --read 0x20000010 4 "Filter_copy.bin" -fillmemory 0x20000004 size=4 pattern=0 --read 0x20000000 0x400 "Temp.bin" --read 0x20000000 0x1028 "Data.bin" -fillmemory 0x20000000 size=4 pattern=0 --write "Filter_copy.bin" 0x20000004
