...
REM cd "c:\RTEdbg\Demo\lpcxpresso54628_hello_world\TEST"
...
"c:\Program Files\SEGGER\JLink\JLink.exe" -If SWD -ExitOnError -CommandFile Snapshot_SingleShotMode_JLINK.cmd
