 ...
 *
 * @note This configuration file was made for the STM32L433 DEMO.
...
#if 1   // Timestamp using the DWT_CYCCNT (CPU core cycle counter)
...
#if 0  // Example: Timer SYSTICK used as the timestamp counter
#define RTE_TIMER_DRIVER  "rtedbg_timer_systick.h"
#define RTE_TIMESTAMP_SHIFT   1U
#define RTE_GET_TSTAMP_FREQUENCY() SystemCoreClock // Current core frequency [Hz]
#endif

#if 0   // Example: Timer TIM2 used as the timestamp counter for the STM32L4 family
#define RTE_TIMER_DRIVER  "rtedbg_timer_stm32L4_tim2.h"
#define RTE_TIMESTAMP_PRESCALER     8U
    // Divide the timer clock by (RTE_TIMESTAMP_PRESCALER * 2).
    // Additional division by 2 is due to implementation of data logging functions
#define RTE_TIMESTAMP_SHIFT   1U
#define RTE_GET_TSTAMP_FREQUENCY() 1000000U
#endif

#if 0   // Hardware independent timestamp - use just for test of data logging library
#define RTE_TIMER_DRIVER  "rtedbg_timer_test.h"
    // It should be used only for test after the code is ported to a new CPU core or compiler
#define RTE_TIMESTAMP_SHIFT   1U
