...
"c:\ST\STM32CubeProgrammer\bin\STM32_Programmer_CLI.exe" -c port=SWD mode=HOTPLUG shared -q --read 0x10000004 4 "Filter.bin" -fillmemory 0x10000004 size=4 pattern=0 --read 0x10000000 0x800 "Temp.bin" --read 0x10000000 0x2028 "Data.bin" --write "Filter.bin" 0x10000004
