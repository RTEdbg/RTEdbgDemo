...
"c:\RTEdbg\UTIL\RTEgetData\RTEgetData.exe" 61234 0x10000000 0 -p -decode=Decode.bat -filter=0xFFFFFFFF -start=continue.cmd -priority -driver=stlinkserver.exe -driver="ST-LINK_gdbserver.exe"
