...
"c:\RTEdbg\UTIL\RTEgdbData\RTEgdbData.exe" 61234 0x24000000 0 -p -decode=Decode.bat -filter=0xFFFFFFFF -start=continue.cmd -priority -driver=stlinkserver.exe -driver="ST-LINK_gdbserver.exe"
