#ifndef RTE_CORTEX_M7_FAULT_H
#define RTE_CORTEX_M7_FAULT_H

/* cortex_M7_fault.h - format definitions for the source file "fault_handler.c" */

// IN_FILE(EXC_NAMES, "cortex_M7_exceptions.txt")

// MSGN23_FATAL_EXCEPTION
// "Register dump"
