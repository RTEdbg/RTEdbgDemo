 ...
 *
 * @note This configuration file was made for the STM32H743 DEMO.
...
#if 0   // Example: Timer TIM2 used as the timestamp counter for the STM32H7 family
#define RTE_TIMER_DRIVER  "rtedbg_timer_stm32h7_tim2.h"
