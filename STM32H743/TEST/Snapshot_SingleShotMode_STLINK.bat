...
REM cd "c:\RTEdbg\Demo\STM32H743\TEST"
...
"c:\ST\STM32CubeProgrammer\bin\STM32_Programmer_CLI.exe" -c port=SWD mode=HOTPLUG shared -q --read 0x24000010 4 "Filter_copy.bin" -fillmemory 0x24000004 size=4 pattern=0 --read 0x24000000 0x400 "Temp.bin" --read 0x24000000 0x2028 "Data.bin" -fillmemory 0x24000000 size=4 pattern=0 --write "Filter_copy.bin" 0x24000004
